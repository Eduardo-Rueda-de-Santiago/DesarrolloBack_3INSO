...
export const registerUser = [
	...
	body("password")
		.isString()
		.isStrongPassword({ minLowercase: 1, minUppercase: 1, minNumbers: 1, minSymbols: 1 }).withMessage("La contraseña debe tener al menos una minúscula, una mayúscula y un número.")
